...
const WarningMenu = () => {
    ...
    const handleClick = () => {
        gsap.to(contentRef.current, {
            ...
            duration: 0.5,
            onComplete: () => {
                // Wait 2 seconds before changing the background
                setTimeout(() => {
                    setFadeOutBackground(true);
                    navigate("/main-menu"); // Navigate after the animation
                }, 1000);
            },
        });
    };
            ...
            >
                ...
                <div className="flex items-center mt-24">
                    <div className="font-rodin font-black text-xl md:text-3xl text-center text-white md:ml-4">
                        HI, MY NAME IS <i>Liban Mahdi</i>. I AM A COMPUTER SCIENCE
                        STUDENT.
                    </div>
                </div>
